...
import { DualProcessRouter, SkillStore, ExperienceLearner, System1Executor } from "../packages/intelligence/src/index.js";
...
async function runBenchmark() {
  ...
  const router = new DualProcessRouter(skillStore, { confidenceThreshold: 0.75, minUsageForFastPath: 0 }); // Allow fast path immediately for demo
